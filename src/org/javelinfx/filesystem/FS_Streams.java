...
public class FS_Streams {
  ...
  static public String readAsString(final File pInput, final Charset pEncoding) throws IOException {
    try (FileInputStream fis = new FileInputStream(pInput)) {
      return readAsString( fis, pEncoding );
    }
  }
